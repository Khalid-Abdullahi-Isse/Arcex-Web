  ...
  return (
    <div className="min-h-[calc(100vh-2rem)] bg-pf-bg-base">
      <header className="sticky top-0 z-20 border-b border-pf-border-subtle bg-pf-bg-base">
        {step > 1 ? (
          <div className="mx-auto grid h-14 max-w-[720px] grid-cols-[72px_1fr_72px] items-center px-5">
            <button
              type="button"
              aria-label="Back"
              onClick={goBack}
            ...
            <button
              type="button"
              onClick={exitFlow}
              className="justify-self-end text-[16px] font-semibold text-pf-accent"
            >
              Exit
            </button>
          </div>
          ...
          action={
            step === 1 ? (
              <button
                type="button"
                onClick={exitFlow}
                className="text-[16px] font-semibold text-pf-accent"
              >
                Exit
              </button>
            ) : null
      ...
      {step > 1 ? (
        <footer className="fixed inset-x-0 bottom-0 z-20 border-t border-pf-border-subtle bg-pf-bg-base px-6 py-5">
          <div className="mx-auto flex max-w-[720px] justify-center gap-4">
            {step === 2 ? (
              <Button
                type="button"
                variant="outline"
            ...
            <Button
              ...
              className={
                step === 2
                  ? "h-14 flex-1 rounded-xl text-[18px] font-semibold"
                  : "h-14 w-full max-w-[380px] rounded-xl text-[18px] font-semibold"
              }
              onClick={() => {
                if (step === 2) setStep(3);
                if (step === 3) setStep(4);
